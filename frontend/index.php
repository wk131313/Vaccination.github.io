        ...
        <div class="container py-5">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <a class="btn btn-dark rounded-pill py-3 px-5 me-3" href="appointment.php">Book An Appointment</a>
                ...
                <div class="col-lg-6">
                    <!-- <div class="bg-white text-center rounded p-5"> -->
                        ...
                        <form>
                            <div class="row g-3">
                            <img  src="img/doctor appoint.jpg" alt="" style="height: 500px;">
    ...
    <!-- <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                ...
                <h1 class="display-4">Vaccine Programs</h1>
            </div>
            <div class="owl-carousel price-carousel position-relative" style="padding: 0 45px 45px 45px;">
                <div class="bg-light rounded text-center">
                    <div class="position-relative">
                        <img class="img-fluid rounded-top" src="img/v1.jpg" alt="">
                        <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style="background: rgba(29, 42, 77, .8);">
                            <h3 class="text-white">Hepatitis B</h3>
                            <h1 class="display-4 text-white mb-0">
                            <small class="align-top fw-normal" style="font-size: 22px; line-height: 45px;">$</small>175<small class="align-bottom fw-normal" style="font-size: 16px; line-height: 40px;">/ Year</small>
                            </h1>
                        </div>
                    </div>
                    <div class="text-center py-5">
                        ...
                        <a href="vaccineform.php" class="btn btn-primary rounded-pill py-3 px-5 my-2">Apply Now</a>
                    </div>
                </div>
                <div class="bg-light rounded text-center">
                    <div class="position-relative">
                ...
                <div class="bg-light rounded text-center">
                    <div class="position-relative">
                        <img class="img-fluid rounded-top" src="img/v1.jpg" alt="">
                        <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style="background: rgba(29, 42, 77, .8);">
                            <h3 class="text-white">Toxoid Vaccines</h3>
                            <h1 class="display-4 text-white mb-0">
                ...
                <div class="bg-light rounded text-center">
                    <div class="position-relative">
                    <a href=""><img class="card-img-top" src="admin/upload/<?php echo $row["post_img"]; ?>" alt=""></a>
                        <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style="background: rgba(29, 42, 77, .8);">
            ...
            <div class="row g-5">
                <!-- <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        <img class="img-fluid w-100 h-10" src="img/blog-1.jpg" alt="">
                        <div class="p-4">
                            <a class="h3 d-block mb-3" href="detail.html">PrepYourHealth with Vaccines</a>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            <a class="h3 d-block mb-3" href="detail2.html">5 Good Reasons to Get a Flu Vaccine This Season</a>
                            <p class="m-0">Dolor lorem eos dolor duo et eirmod sea. Dolor sit magna
                                rebum clita rebum dolor stet amet justo</p>
                        </div>
                        <div class="d-flex justify-content-between border-top p-4">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            <a class="h3 d-block mb-3" href="detail3.html">Prepare Your Health: Falling Into Asthma</a>
                            <p class="m-0">Dolor lorem eos dolor duo et eirmod sea. Dolor sit magna
                                rebum clita rebum dolor stet amet justo</p>
                        </div>
                        <div class="d-flex justify-content-between border-top p-4">

          ...
          <div class="card">
            ...
            if (mysqli_num_rows($result) > 0) {
              echo 'User already exist';
                ...
                include "config.php";
                $query = "INSERT INTO `user`(`f_name`, `l_name`,`phone`, 
                `email`, `address`, `role`,`city`, `username` ,`password`) 
                VALUES ('{$user_fname}','{$user_lname}','{$user_phone}','{$user_email}',
                '{$user_address}','{$user_role}','{$user_city}','{$user_name}',
                '{$user_password}')";
                mysqli_query($conn, $query);
                header("location:http://localhost/Vaccine/html/user.php");
            }
        }
